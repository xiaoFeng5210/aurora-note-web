...
import { variants, itemVariants, logoVariants, foldVariants } from './animate.tsx'
...
const SlideBar: FC = () => {
  ...
  return (
    <motion.div className='tw-w-[300px] tw-h-full tw-bg-[#FBFBFA] tw-px-2'>
      <header className='tw-py-2 tw-w-full tw-inline-flex tw-items-center tw-cursor-pointer'>
        ...
        <motion.span variants={foldVariants} initial="hidden" whileTap="tap" whileHover="visible" className='tw-ml-auto'><ArrowLeftToLine  color="#9A9996" /></motion.span>
      </header>
